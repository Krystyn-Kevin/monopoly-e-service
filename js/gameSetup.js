 ...
 * @param {string} opts.createdBy uid of whoever is signed in and running this
 *        wizard — not necessarily the same person as the Banker (e.g. a
 *        parent setting the game up for two kids who'll actually play).
 ...
 */
export async function createGame({ bankerUid, createdBy, players }) {
